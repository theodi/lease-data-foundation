...
Mongo search indexes must be set up in MongoDB Atlas to support the application's search functionality. Also, field indexes should be created for optimal query performance.
